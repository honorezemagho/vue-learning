...
<div class="modal">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 131 131" aria-labelledby="face" role="presentation" width="70" height="70">
        ...
        <path :class="[uiState === 'lost' ? 'frown' : '', 'cls3']" d="M51,97s6,10,23,10S95,97,95,97" transform="translate(-8.5 -5.5)" />
    </svg>
    <p>
